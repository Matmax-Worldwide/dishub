...
const HeroSection = React.memo(function HeroSection({ 
  ...
  return (
    <section className={cn(
      "relative w-full bg-gradient-to-b from-white to-blue-50 overflow-hidden flex items-center min-h-screen",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
            ...
            {localShowIcon && (
              <motion.div
                ...
                className="relative icon-container flex items-center justify-center z-30"
